...
export class InitDatabase1666547174254 implements MigrationInterface {
    name = 'InitDatabase1666547174254'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "publication" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" text NOT NULL, "imageId" uuid, "userId" uuid, "establishmentId" uuid, CONSTRAINT "PK_8aea8363d5213896a78d8365fab" PRIMARY KEY ("id"))`);
